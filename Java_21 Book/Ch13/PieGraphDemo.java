//NOTE: add functionality for size in .addslice(color, size) to be an argument
//and to have labels automatically included.  This would make it easy for 
//a program to display data with a pie graph of varying input

import java.awt.*;
import javax.swing.*;
import java.awt.geom.*;

public class PieGraphDemo extends JFrame {
    public PieGraphDemo() {
        super("Pie Graph");
        setSize(322, 322);
    ...
    public static void main(String[] arguments) {
        PieGraphDemo pg = new PieGraphDemo();
    }
}       
